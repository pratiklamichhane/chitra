    ...
    <section className="fluent-card">
      ...
      <div className="export-grid">
        <span
          ...
          title={!canExport ? "Please process an image first to enable export options" : undefined}
        ...
        <span
          className="inline-flex w-full min-w-0"
          title={!canExport ? "Please process an image first to enable print options" : undefined}
          tabIndex={!canExport ? 0 : undefined}
        >
