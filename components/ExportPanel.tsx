...
export function ExportPanel({ canExport, onExportPng, onExportPdf, onPrint }: ExportPanelProps) {
  const disabledTooltip = !canExport ? "Process an image first to enable export options" : undefined;
  ...
  return (
    <section className="fluent-card">
      ...
      <div className="export-grid">
        <span title={disabledTooltip} tabIndex={disabledTabIndex} className="inline-flex w-full min-w-0">
