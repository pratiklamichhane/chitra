...
export function ExportPanel({ canExport, onExportPng, onExportPdf, onPrint }: ExportPanelProps) {
  const disabledTitle = !canExport ? "Upload and process an image first" : undefined;
  ...
  return (
    <section className="fluent-card">
      ...
      <div className="export-grid">
        <span className="inline-flex w-full min-w-0" title={disabledTitle} tabIndex={disabledTabIndex}>
