  ...
  return (
    <section className="fluent-card">
      ...
      <div className="export-grid">
        <span className="inline-flex w-full" title={!canExport ? "Process an image first to export" : undefined} tabIndex={!canExport ? 0 : undefined}>
        ...
        <span className="inline-flex w-full" title={!canExport ? "Process an image first to print" : undefined} tabIndex={!canExport ? 0 : undefined}>
