  ...
  return (
    <section className="fluent-card">
      ...
      <div className="export-grid">
        <span className="inline-flex w-full" title={!canExport ? "Process an image first to export" : undefined}>
        ...
        <span className="inline-flex w-full" title={!canExport ? "Process an image first to print" : undefined}>
