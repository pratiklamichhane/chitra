  ...
  return (
    <section className="fluent-card">
      ...
      <div className="export-grid">
        <span className="inline-flex w-full" title={!canExport ? "Process a photo to enable export" : undefined} tabIndex={!canExport ? 0 : undefined}>
        ...
        <span className="inline-flex w-full" title={!canExport ? "Process a photo to enable print" : undefined} tabIndex={!canExport ? 0 : undefined}>
