...
export function ExportPanel({ canExport, onExportPng, onExportPdf, onPrint }: ExportPanelProps) {
  const disabledTooltip = !canExport ? "Process a photo to enable export" : undefined;
  ...
  return (
    <section className="fluent-card">
      ...
      <div className="export-grid">
        <span title={disabledTooltip} tabIndex={tabIndex} className="inline-flex w-full min-w-0">
