      ...
      <header className="topbar">
        ...
        <div className="topbar-status">
          <div className="topbar-actions">
            <span title={!canExport ? "Upload a photo to export" : "Export PNG"} tabIndex={!canExport ? 0 : undefined} className="inline-flex">
              <button className="chrome-button" aria-label="Export PNG" disabled={!canExport} onClick={exportPng}>
                <DownloadCloud size={16} />
              </button>
            </span>
            <span title={!canExport ? "Upload a photo to export" : "Export PDF"} tabIndex={!canExport ? 0 : undefined} className="inline-flex">
              <button className="chrome-button" aria-label="Export PDF" disabled={!canExport} onClick={exportPdf}>
                <FileText size={16} />
              </button>
            </span>
            <span title={!canExport ? "Upload a photo to print" : "Print"} tabIndex={!canExport ? 0 : undefined} className="inline-flex">
