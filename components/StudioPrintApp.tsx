      ...
      <header className="topbar">
        ...
        <div className="topbar-status">
          <div className="topbar-actions">
            <button className="chrome-button" title={canExport ? "Export PNG" : "Process a photo to enable Export PNG"} aria-label="Export PNG" disabled={!canExport} onClick={exportPng}>
              <DownloadCloud size={16} />
            </button>
            <button className="chrome-button" title={canExport ? "Export PDF" : "Process a photo to enable Export PDF"} aria-label="Export PDF" disabled={!canExport} onClick={exportPdf}>
              <FileText size={16} />
            </button>
            <button className="chrome-button" title={canExport ? "Print" : "Process a photo to enable Print"} aria-label="Print" disabled={!canExport} onClick={print}>
              <Printer size={16} />
            </button>
