      ...
      <header className="topbar">
        ...
        <div className="topbar-status">
          <div className="topbar-actions">
            <span
              title={!canExport ? "Add a photo to enable export" : "Export PNG"}
            ...
            <span
              title={!canExport ? "Add a photo to enable export" : "Export PDF"}
              tabIndex={!canExport ? 0 : undefined}
            >
            ...
            <span
              title={!canExport ? "Add a photo to enable export" : "Print"}
              tabIndex={!canExport ? 0 : undefined}
            >
