        ...
        <div className="topbar-status">
          <div className="topbar-actions">
            <span
              ...
              title={!canExport ? "Upload and process an image to export" : "Export PNG"}
            ...
            <span
              className="inline-flex"
              title={!canExport ? "Upload and process an image to export" : "Export PDF"}
              tabIndex={!canExport ? 0 : undefined}
            >
            ...
            <span
              className="inline-flex"
              title={!canExport ? "Upload and process an image to print" : "Print"}
              tabIndex={!canExport ? 0 : undefined}
            >
