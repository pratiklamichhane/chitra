    ...
    <div className="modal-overlay">
      <div className="modal-content cleanup-modal">
        <div className="modal-header">
          ...
          <button className="modal-close-button" onClick={handleClose} aria-label="Close" title="Close">
            <X size={20} />
          </button>
        </div>
        ...
        <div className="modal-body cleanup-modal-body">
          ...
          <div className="cleanup-controls">
            <div className="cleanup-toolbar">
              <button type="button" className="icon-button" disabled={!hasSubject} onClick={() => updateViewZoom((current) => current - 0.2)} aria-label="Zoom out" title="Zoom out">
                <ZoomOut size={15} />
              </button>
              <button type="button" className="icon-button" disabled={!hasSubject} onClick={() => updateViewZoom(1)} aria-label="Fit view" title="Fit view">
                <Maximize size={15} />
              </button>
              <button type="button" className="icon-button" disabled={!hasSubject} onClick={() => updateViewZoom((current) => current + 0.2)} aria-label="Zoom in" title="Zoom in">
                <ZoomIn size={15} />
              </button>
