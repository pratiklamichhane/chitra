        ...
        <div className="modal-body cleanup-modal-body">
          ...
          <div className="cleanup-controls">
            <div className="cleanup-toolbar">
              <button type="button" className="icon-button" disabled={!hasSubject} onClick={() => updateViewZoom((current) => current - 0.2)} title="Zoom out" aria-label="Zoom out">
                <ZoomOut size={15} />
              </button>
              <button type="button" className="icon-button" disabled={!hasSubject} onClick={() => updateViewZoom(1)} title="Fit view" aria-label="Fit view">
                <Maximize size={15} />
              </button>
              <button type="button" className="icon-button" disabled={!hasSubject} onClick={() => updateViewZoom((current) => current + 0.2)} title="Zoom in" aria-label="Zoom in">
                <ZoomIn size={15} />
              </button>
